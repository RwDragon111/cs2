...
def default_payment_profiles(settings: Settings) -> dict[str, MarketPaymentProfile]:
    profiles = [
        ...
        MarketPaymentProfile(
            ...
            currency_conversion_required=False,
            estimated_conversion_fee_percent=Decimal("0"),
            notes="Best public buy orders from Market.CSGO; used as the paper sell side.",
        ),
        MarketPaymentProfile(
        ...
        MarketPaymentProfile(
            ...
            currency_conversion_required=False,
            estimated_conversion_fee_percent=Decimal("0"),
            notes="Mock profile mirroring Market.CSGO buy orders.",
        ),
        MarketPaymentProfile(
            market_name="DMarket",
            supports_rub=False,
            ...
            estimated_conversion_fee_percent=Decimal("1.0"),
            notes="Enabled for paper monitoring. Real buys remain disabled in MVP.",
        ),
        MarketPaymentProfile(
            ...
            currency_conversion_required=True,
            estimated_conversion_fee_percent=Decimal("1.0"),
            notes="Mock profile mirroring DMarket paper monitoring.",
        ),
        MarketPaymentProfile(
        ...
        MarketPaymentProfile(
            ...
            currency_conversion_required=True,
            estimated_conversion_fee_percent=Decimal("1.0"),
            notes="Read-only DMarket sample connector used for market spread diagnostics.",
        ),
    ]
